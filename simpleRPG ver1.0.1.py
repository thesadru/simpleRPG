...
while True:
    ...
    # enemy generation
        ...
        while hero.hp > 0 and enemy.hp > 0:
            ...
            print("         +----------+-----+     +-----------+-----+")
            print("         | stamina  | ",hero.stamina," |     | stamina   | ",enemy.stamina," |")
            print("         +----------+-----+     +-----------+-----+")
            print("         | health   | ",hero.health," |     | health    | ",enemy.health," |") #visual combat
            print("         +----------+-----+     +-----------+-----+")
            ...
            if   difficulty == 0:
                ...
                elif enemy.st>=1: #pseudo random
                    enemy.move = "a" if enemy.movehistory != "a" and time.time()%2==0 and enemy.st>=2 else ( "d" if time.time()%2==1 else ("a" if enemy.st>=2 else "d"))
                    enemy.devmove = "pseudo random charged"
